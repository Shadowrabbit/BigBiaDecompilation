...
public class RongYanGuiLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_94");
		this.Desc = LocalizationMgr.Instance.GetLocalizationWord("CT_D_94");
	}
	...
	public override IEnumerator OnEndTurn(bool isPlayerTurn)
	{
		if (!isPlayerTurn && this.CardData.HP < this.CardData.MaxHP)
		{
			...
			{
				if (cardSlotData.ChildCardData != null && cardSlotData.ChildCardData.ModID.Equals("熔岩"))
				{
