...
public class ExtraLeftCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_58");
		this.Desc = string.Format(LocalizationMgr.Instance.GetLocalizationWord("CT_D_58"), base.Layers);
		Vector3Int vector3Int = Vector3Int.left;
