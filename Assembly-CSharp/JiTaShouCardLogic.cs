...
public class JiTaShouCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_177");
		this.Desc = string.Format(LocalizationMgr.Instance.GetLocalizationWord("CT_D_177"), (this.baseDmg + this.increaseDmg * (float)base.Layers) * 100f);
	}
