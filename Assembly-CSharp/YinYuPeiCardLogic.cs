...
public class YinYuPeiCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_玉佩阴");
		this.Desc = LocalizationMgr.Instance.GetLocalizationWord("CT_D_玉佩阴");
	}
	...
	public override IEnumerator OnCardAfterUseSkill(CardData user, CardLogic origin)
	{
		...
		if (list.Contains(user) && base.GetLogic(user, typeof(YangYuPeiCardLogic)) != null)
		{
