...
public class LanMeiCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_189");
		this.Desc = LocalizationMgr.Instance.GetLocalizationWord("CT_D_189");
	}
	...
	public override void OnMerge(CardData mergeBy)
	{
		...
		if (this.CardData != null && this.CardData.HasTag(TagMap.随从))
		{
			...
			if (cardLogics.Count > 0)
			{
				...
				{
					if (cardLogic.Color == CardLogicColor.blue && cardLogic.Layers > 0)
					{
						list.Add(cardLogic);
					}
				}
			...
			base.RemoveCardLogic(this.CardData, typeof(LanMeiCardLogic), "LanMeiCardLogic");
		}
	}
}
