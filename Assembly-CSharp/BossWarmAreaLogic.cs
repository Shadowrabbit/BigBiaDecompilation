...
public class BossWarmAreaLogic : AreaLogic
{
	public override void BeforeEnter()
	{
		base.Data.CardSlotDatas.Add(this.BossWarmArea.CardSlot.CardSlotData);
		this.BossWarmArea.CardSlot.CardSlotData.SlotOwnerType = CardSlotData.OwnerType.Area;
	}

	public override void BeforeInit()
	{
		GameController.ins.GameData.PaiPaiBossModelPath = "Prefabs/拍扁虫子";
		...
		this.BossWarmArea = UnityEngine.Object.FindObjectOfType<BossWarmArea>();
		this.BossWarmArea.CardSlot.CardSlotData.CurrentAreaData = base.Data;
	}
	...
	public BossWarmArea BossWarmArea;
}
