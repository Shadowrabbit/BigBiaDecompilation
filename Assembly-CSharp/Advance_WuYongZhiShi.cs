...
public class Advance_WuYongZhiShi : AdvanceUIBase
{
	...
	public override void OnButtonClick()
	{
		if (GlobalController.Instance.GlobalData.Money >= this.Price)
		{
			...
			GlobalController.Instance.AdvanceDataController.SetWuYongZhiShi(true);
			this.ButtonImage.sprite = this.Images[1];
			this.BuyButton.interactable = false;
			return;
		}
