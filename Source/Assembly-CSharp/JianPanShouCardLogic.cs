...
public class JianPanShouCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_176");
		this.Desc = string.Format(LocalizationMgr.Instance.GetLocalizationWord("CT_D_176"), (this.baseDmg + this.increaseDmg * (float)base.Layers) * 100f);
	}
	...
	public override IEnumerator OnAfterAttack(CardData player, CardSlotData target)
	{
		...
		if (player == this.CardData)
		{
			...
			{
				CardSlotData cardSlotData = myBattleArea[myBattleArea.IndexOf(this.CardData.CurrentCardSlotData) - 1];
