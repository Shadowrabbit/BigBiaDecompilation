...
public class SingerCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_191");
		this.Desc = string.Format(LocalizationMgr.Instance.GetLocalizationWord("CT_D_191"), (this.baseDmg + this.increaseDmg * (float)base.Layers) * 100f);
	}
