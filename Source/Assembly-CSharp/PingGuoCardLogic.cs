...
public class PingGuoCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_188");
		this.Desc = LocalizationMgr.Instance.GetLocalizationWord("CT_D_188");
	}
	...
	public override void OnMerge(CardData mergeBy)
	{
		...
		if (this.CardData != null && this.CardData.HasTag(TagMap.随从))
		{
			...
			if (cardLogics.Count > 0)
			{
				...
				{
					if (cardLogic.Color == CardLogicColor.red && cardLogic.Layers > 0)
					{
						list.Add(cardLogic);
					}
				}
			...
			base.RemoveCardLogic(this.CardData, typeof(PingGuoCardLogic), "PingGuoCardLogic");
		}
	}
}
