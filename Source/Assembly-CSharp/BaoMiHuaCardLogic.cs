...
public class BaoMiHuaCardLogic : CardLogic
{
	public override void Init()
	{
		base.Init();
		this.Color = CardLogicColor.white;
		this.displayName = LocalizationMgr.Instance.GetLocalizationWord("CT_N_爆米花");
		this.Desc = string.Format(LocalizationMgr.Instance.GetLocalizationWord("CT_D_爆米花"), base.Layers * this.weight);
	}
