...
public class BangZhuXiaoNvHaiCardLogic : CardLogic
{
	...
	public override IEnumerator BeforeFact()
	{
		...
		JournalsConversationManager.PutJournals(new JournalsBean(LocalizationMgr.Instance.GetLocalizationWord("T_小女孩1"), null, null, null, null, null, null));
		yield break;
	}
}
